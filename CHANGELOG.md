...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 720cf54

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 db7f5c3
* **deps:** update dependency tflint to v0.64.0 94fcdfe
* **SREAA-368:** 🔗 bump azurecaf to ~> 1.3.0 and resync the ci template files 5bd5fe2
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 8118145
* **v9:** 🐛 synchronize common files and docs 068bdc6
...
* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ e4950ac

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu e6b47cd
* **deps:** update dependency terraform-docs to v0.23.0 b5a64b3
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 b6d5a7f
* **pre-commit:** 🔧 move to prek 7b8a82e
* **tfdocs:** bump tfdocs to v0.22 🔧 10aff9a

## 8.0.4 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 15249dd

### Code Refactoring

* update module structure and Github actions 👷 7f50845

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing e140982
* **deps:** 🔗 bump tflint rules version b841ba0
* **deps:** update dependency trivy to v0.69.2 f642e25
* **deps:** update dependency trivy to v0.69.3 ba15dc6
